...
PaperReading 仓库材料依据 [MIT 许可证](LICENSE)发布。该许可证约束项目软件及其相关文档，但不会产生复用第三方论文、数据集、用户输入或提取内容的授权。
...
| P11、P12 | [贡献许可规则](CONTRIBUTING.zh-CN.md#贡献许可)、[安全政策](SECURITY.md)、合成示例、变更安全机制与显式文档边界。 |
